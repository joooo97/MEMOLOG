...
public interface WorkspaceService {
	...
	void updateWorkspaceCoverColor(Map<String, Object> param);

	void updateWorkspace(Map<String, Object> param);

	void deleteWorkspace(int workspaceNo);

	String selectWorkspaceType(int workspaceNo);

	void insertWorkspaceMember(Map<String, Object> param);
	...
	void updateWorkspaceMemberRole(Map<String, Object> param);
